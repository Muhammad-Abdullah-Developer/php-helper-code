...
//==Email Process===================
    ...
    $mail->Body = "<h1>$a</h1><p>It takes a Few minutes to reset your password for <h1>$b</h1> Just click reset password link and update your password.</p> <a href='http://localhost/all/update_password.php'>Reset Your Password</a>";
